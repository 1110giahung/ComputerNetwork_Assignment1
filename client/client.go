<<<<<<< HEAD:ComputerNetwork_Ass1/client/client.go
package client
...
func StartDownload(torrentFilePath string, indexFilePath string) {
	...
	tf, err := torrent.Open(realTorrentPath)
	if err != nil {
	...
	peers := []string{"192.168.1.19:8080"}
...
>>>>>>> 08c2e09d171dc6aaee478bcff82895bc0cf7eeb6:client/client.go
